...
var LK_I18N = {
  ...
  ko: {
    ...
    'cat.kdrama.sub': '한국 드라마',
    'cat.kmusic.name': 'K-뮤직',
    'cat.kmusic.sub': 'K-팝 & 그 이상',
    'cat.kent.name': 'K-엔터테인먼트',
    'cat.kent.sub': '예능 & 버라이어티',
    'cat.coming': '콘텐츠 준비 중',
    'download.label': '📲 앱 다운로드',
    'download.sub': '언제 어디서든 — Live Korean을 함께하세요.',
    'download.ios': 'App Store에서 다운로드',
    'download.android': 'Google Play에서 받기',
    'download.soon': '앱 출시 예정',
